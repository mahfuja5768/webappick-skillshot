...
const SkillShootPic = () => {
  return (
    <div className="hidden lg:col-span-2  relative lg:flex justify-center items-center">
      <img
      ...
      <img
        ...
        alt="bannerPerson"
      />
      <div className="bg-white/70 px-4 py-3 rounded-xl z-10 absolute bottom-12 right-0 flex justify-between gap-3">
